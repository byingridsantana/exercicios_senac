...
def atualizar_publicacao(titulo, autor, editora, data_publicacao, isbn, assunto, tipo_publicacao, palavras_chave, quantidade, localizacao, id):
    banco, cursor = conectar_banco()
    ...
    cursor.close()
    banco.close()
    print("Os dados da publicação foram atualizados")
...
def apagar_publicacao(id):
    ...
    cursor.close()
    banco.close()
    print("Os dados da publicação foram apagados!")