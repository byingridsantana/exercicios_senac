...
# Para criar uma função em python iremos utilizar o comando def(definição)

def mudarNome(ar_or,nv_ar):
    """
    A função mudarNome, altera o nome de um arquivo.
    O usuário deve passar o nome original do arquivo e o novo nome.
...
arquivo_original = input("Digite o nome do arquivo que será renomedo: ")
